...
#### ✅ Fase 7: Auto-Print con Trigger Push (COMPLETATA)
...
- [x] Timestamp JS troncato a 9 cifre per compatibilità unsigned long ESP32
...
```
████████ 26/0077 (1/2) ████████  ← riga intera nera, testo bianco centrato
Lenarduzzi Bruno                  ← font normale
21.01.26 - 339/7808759 - Sesto    ← font condensato (ESC M 1)
Levigatrice rupes - batteria      ← font normale
...
- Multi-attrezzo: etichette separate con (1/2), pausa 10s
