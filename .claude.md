...
- `magazzino`: 30 minuti (uso intensivo ripetuto)
...
- Durate cache strategiche (30 min per magazzino)
- **Aggiornamento locale cache dopo batch insert** (fix bug visibilità)
- Throttle GitHub Actions: 5 min → 10 min
...
- **Attuale:** 30 min magazzino OK per uso singolo utente
...
- [ ] Riapertura <30 min → 0.1s istantaneo
