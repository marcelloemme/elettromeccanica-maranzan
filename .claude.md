...
│   ├── magazzino-test.html     # Editor bulk scaffali (desktop-only ≥1440px)
...
│   ├── magazzino-test.js       # Editor bulk scaffali + generazione PDF cartellini
...
5. "Salva tutto" → **batch insert** singola chiamata API Google Apps Script
...
- Visibilità immediata: 0.1s

---

### UC8: Editor Bulk Scaffali (Desktop)

**Attore:** Amministratore gestisce contenuto scaffali da desktop

**Pagina:** `/html/magazzino-test.html` + `/js/magazzino-test.js`
...
**Versione cache attuale:** `em-maranzan-v106`
...
js/magazzino-nuovo.js        → riga 2: API_URL
