...
**Soluzione:**
1. Bump `CACHE_NAME` in `sw.js` (es: v7 → v8)
2. Bump query parameter in `html/magazzino.html` (es: ?v=7 → ?v=8)
3. Commit e push
4. La PWA si auto-aggiorna e ricarica automaticamente alla prossima apertura

**Nota:** Il sistema ora include auto-reload del SW, non serve hard refresh manuale
