...
2. Visualizza 4 sezioni:
   - **Recap attuale:** totale riparazioni in corso + top 3 più vecchie (o oltre 90gg se presenti)
   - **Recap settimanale:** sempre visibile, dati settimana corrente o scorsa
     - Sabato dopo 17:30 o domenica: "Questa settimana (date)"
     - Lunedì-sabato prima 17:30: "Settimana scorsa (date)"
     - Confronto con media calcolata dal 27 ottobre 2025 (non prima, per evitare settimane vuote)
   - **Tempi riparazione:** ultimi 90 giorni (media, record velocità/lentezza, percentuali entro 14/30/60 giorni)
   - **Grafici mensili:** riparazioni aggiunte/completate per mese, multi-anno con toggle
3. Grafici con colori fissi per anno (2026=blu, 2025=verde, 2024=arancione, ecc.)
4. Click "Aggiorna statistiche" → trigger manuale GitHub Action → aggiornamento dati in ~2 min

**Sistema automatico:**
- GitHub Action esegue daily alle 19:30 GMT+1
- Script Node.js (`js/generate-statistics.js`) scarica CSV, calcola metriche, salva JSON
- Frontend carica `js/statistiche.json` e renderizza con Chart.js

**Metriche calcolate:**
- Recap attuale: totale in corso, oltre 90gg, top 3 più vecchie
- Recap settimanale: inserite/completate vs media ultimi 6 mesi (ma dal 27 ottobre 2025 minimo)
- Tempi: media giorni, record velocità/lentezza, percentuali completamento
- Grafici: count mensile per anno (create/completate)
