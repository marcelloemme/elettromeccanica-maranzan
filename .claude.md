...
- Throttle: max 1 esecuzione ogni 5 minuti (sincronizzato con durata cache)
...
- `magazzino`: 5 minuti (aggiornamenti più frequenti)
...
**Soluzione:** Throttle 5 minuti implementato - max 12 trigger/ora
...
- **Attuale:** 5 min magazzino per sincronizzazione rapida con Google Sheets
...
- [ ] Riapertura <5 min → 0.1s istantaneo
- [ ] Riapertura >5 min → ricarica CSV aggiornato
