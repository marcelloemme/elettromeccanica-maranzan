...
**Salvataggio:**
- Popup riepilogo modifiche (aggiunti/modificati/eliminati)
- Chiamata API `batchOperations` (add + update + delete in singola transazione)
- Payload: `{ action: 'batchOperations', adds: [...], updates: [...], deletes: [...] }`
- Updates supportano cambio codice: `{ oldCodice, newCodice, newDescrizione, newScaffale }`
...
- [ ] Popup stampa auto-compilato con scaffali modificati nella sessione
- [ ] Rapportino finale PDF con riepilogo modifiche/aggiunte/eliminazioni
- [ ] Funzione "Sposta": spostare un pezzo in un altro scaffale
...
**Versione cache attuale:** `em-maranzan-v107`
